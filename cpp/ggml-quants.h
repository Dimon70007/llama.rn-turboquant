...
LM_GGML_API size_t quantize_turbo3_0(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
LM_GGML_API size_t quantize_turbo4_0(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
LM_GGML_API void quantize_row_turbo2_0_ref(const float * LM_GGML_RESTRICT x, block_turbo2_0 * LM_GGML_RESTRICT y, int64_t k);
LM_GGML_API void dequantize_row_turbo2_0(const block_turbo2_0 * LM_GGML_RESTRICT x, float * LM_GGML_RESTRICT y, int64_t k);
LM_GGML_API size_t quantize_turbo2_0(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

// TQ3_1S: WHT-rotated 3-bit weight quantization (8-level Lloyd-Max)
LM_GGML_API void quantize_row_tq3_1s_ref(const float * LM_GGML_RESTRICT x, block_tq3_1s * LM_GGML_RESTRICT y, int64_t k);
LM_GGML_API void dequantize_row_tq3_1s(const block_tq3_1s * LM_GGML_RESTRICT x, float * LM_GGML_RESTRICT y, int64_t k);
LM_GGML_API size_t quantize_tq3_1s(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

// TQ4_1S: WHT-rotated 4-bit weight quantization (16-level Lloyd-Max)
LM_GGML_API void quantize_row_tq4_1s_ref(const float * LM_GGML_RESTRICT x, block_tq4_1s * LM_GGML_RESTRICT y, int64_t k);
LM_GGML_API void dequantize_row_tq4_1s(const block_tq4_1s * LM_GGML_RESTRICT x, float * LM_GGML_RESTRICT y, int64_t k);
LM_GGML_API size_t quantize_tq4_1s(const float * LM_GGML_RESTRICT src, void * LM_GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
