...
#ifndef LM_GGML_COMMON_DECL

#if defined(LM_GGML_COMMON_DECL_C)
#include <stdint.h>
...
#if defined(LM_GGML_COMMON_DECL)
...
static_assert(sizeof(block_q1_0) == sizeof(lm_ggml_half) + QK1_0 / 8, "wrong q1_0 block size/padding");
...
static_assert(sizeof(block_q4_0) == sizeof(lm_ggml_half) + QK4_0 / 2, "wrong q4_0 block size/padding");
...
static_assert(sizeof(block_q5_0) == sizeof(lm_ggml_half) + sizeof(uint32_t) + QK5_0 / 2, "wrong q5_0 block size/padding");
...
static_assert(sizeof(block_q5_1) == 2 * sizeof(lm_ggml_half) + sizeof(uint32_t) + QK5_1 / 2, "wrong q5_1 block size/padding");
...
static_assert(sizeof(block_q8_0) == sizeof(lm_ggml_half) + QK8_0, "wrong q8_0 block size/padding");
...
typedef struct {
    lm_ggml_half  norm;                    //  2 bytes: vector L2 norm (for rescaling)
...
typedef struct {
    ...
    lm_ggml_half  rnorm;                   //  2 bytes (reserved, unused in 4-bit mode)
...
typedef struct {
    lm_ggml_half  norm;                    //  2 bytes
    lm_ggml_half  rnorm;                   //  2 bytes: residual norm for QJL scale
    uint8_t    qs[QK_TURBO4 * 3 / 8];  // 48 bytes: 3-bit PolarQuant indices
    uint8_t    signs[QK_TURBO4 / 8];   // 16 bytes: 1-bit QJL signs
} block_turbo4_0;                       // 68 bytes total
static_assert(sizeof(block_turbo4_0) == 2*sizeof(lm_ggml_half) + QK_TURBO4*3/8 + QK_TURBO4/8, "wrong turbo4_0 block size");
#endif
...
typedef struct {
    lm_ggml_half  norm;                    //  2 bytes: corrected L2 norm
    uint8_t    qs[QK_TURBO2 / 4];      //  8 bytes: 2-bit indices (4 per byte)
} block_turbo2_0;                       // 10 bytes total
static_assert(sizeof(block_turbo2_0) == sizeof(lm_ggml_half) + QK_TURBO2/4, "wrong turbo2_0 block size/padding");
...
#define QK_TQ3_0 32
typedef struct {
    lm_ggml_half d0;                       //  2 bytes: scale for first 16 elements
    lm_ggml_half d1;                       //  2 bytes: scale for last 16 elements
...
static_assert(sizeof(block_q6_K) == sizeof(lm_ggml_half) + QK_K / 16 + 3*QK_K/4, "wrong q6_K block size/padding");
...
static_assert(sizeof(block_iq2_xxs) == sizeof(lm_ggml_half) + QK_K/8*sizeof(uint16_t), "wrong iq2_xxs block size/padding");
...
static_assert(sizeof(block_iq2_xs) == sizeof(lm_ggml_half) + QK_K/8*sizeof(uint16_t) + QK_K/32, "wrong iq2_xs block size/padding");
...
static_assert(sizeof(block_iq2_s) == sizeof(lm_ggml_half) + QK_K/4 + QK_K/16, "wrong iq2_s block size/padding");
...
static_assert(sizeof(block_iq1_s) == sizeof(lm_ggml_half) + QK_K/8 + QK_K/16, "wrong iq1_s block size/padding");
...
#define LM_GGML_TABLE_BEGIN(type, name, size) static const constant type name[size] = {
#define LM_GGML_TABLE_END() };
...
#define LM_GGML_COMMON_IMPL
#elif defined(LM_GGML_COMMON_IMPL_SYCL)
...
#if defined(LM_GGML_COMMON_IMPL)

LM_GGML_TABLE_BEGIN(uint8_t, kmask_iq2xs, 8)
    1, 2, 4, 8, 16, 32, 64, 128
LM_GGML_TABLE_END()

LM_GGML_TABLE_BEGIN(uint8_t, ksigns_iq2xs, 128)
...
LM_GGML_TABLE_BEGIN(uint64_t, iq2xs_grid, 512)
    0x0808080808080808, 0x080808080808082b, 0x0808080808081919, 0x0808080808082b08,
...
LM_GGML_TABLE_BEGIN(uint64_t, iq2s_grid, 1024)
    0x0808080808080808, 0x080808080808082b, 0x0808080808081919, 0x0808080808082b08,
    0x0808080808082b2b, 0x0808080808190819, 0x0808080808191908, 0x080808080819192b,
    0x0808080808192b19, 0x08080808082b0808, 0x08080808082b082b, 0x08080808082b1919,
    0x08080808082b2b08, 0x0808080819080819, 0x0808080819081908, 0x080808081908192b,
...
LM_GGML_TABLE_BEGIN(uint32_t, iq3xxs_grid, 256)
...
LM_GGML_TABLE_BEGIN(uint32_t, iq3s_grid, 512)
...
LM_GGML_TABLE_END()
#else
LM_GGML_TABLE_BEGIN(uint32_t, iq1s_grid_gpu, NGRID_IQ1S)
...
typedef struct {
    ...
    uint64_t nb32;
    uint64_t nb33;
} lm_ggml_metal_kargs_flash_attn_ext_pad;
...
typedef struct {
    ...
    uint64_t nb32;
    uint64_t nb33;
} lm_ggml_metal_kargs_flash_attn_ext_blk;
...
typedef struct {
    int32_t  nrows;
} lm_ggml_metal_kargs_flash_attn_ext_vec_reduce;
...
typedef struct{
    ...
    float    alpha;
    float    limit;
} lm_ggml_metal_kargs_glu;

typedef struct {
    uint64_t np;
} lm_ggml_metal_kargs_sum;
...
typedef struct {
    ...
    uint64_t nb12;
    uint64_t nb13;
} lm_ggml_metal_kargs_count_equal;
...
#ifdef LM_GGML_METAL_HAS_TENSOR
...
//
#if __METAL_VERSION__ < 310 && defined(LM_GGML_METAL_HAS_BF16)
#undef LM_GGML_METAL_HAS_BF16
#endif
...
kernel void kernel_unary_impl(
        constant lm_ggml_metal_kargs_unary & args,
...
kernel void kernel_add_id(
        constant lm_ggml_metal_kargs_add_id & args,
        device const char * src0,
        device const char * src1,
...
kernel void kernel_reglu(
        constant lm_ggml_metal_kargs_glu & args,
        device const char * src0,
        device const char * src1,
        device       char * dst,
...
kernel void kernel_op_sum_f32(
        constant lm_ggml_metal_kargs_sum & args,
...
kernel void kernel_sum_rows_impl(
        constant lm_ggml_metal_kargs_sum_rows & args,
        device const char * src0,
        device       char * dst,
...
kernel void kernel_cumsum_blk(
        constant lm_ggml_metal_kargs_cumsum_blk & args,
        device const char * src0,
        device       char * tmp,
        device       char * dst,
        threadgroup  char * shmem [[threadgroup(0)]],
...
kernel void kernel_cumsum_add(
        constant lm_ggml_metal_kargs_cumsum_add & args,
...
bool _lm_ggml_vec_tri_cmp(const int i, const int r);

template<>
bool _lm_ggml_vec_tri_cmp</* LM_GGML_TRI_TYPE_LOWER */ 3>(const int i, const int r) {
    return i < r;
}

template<>
bool _lm_ggml_vec_tri_cmp</* LM_GGML_TRI_TYPE_LOWER_DIAG */ 2>(const int i, const int r) {
    return i <= r;
}

template<>
bool _lm_ggml_vec_tri_cmp</* LM_GGML_TRI_TYPE_UPPER */ 1>(const int i, const int r) {
    return i > r;
}

template<>
bool _lm_ggml_vec_tri_cmp</* LM_GGML_TRI_TYPE_UPPER_DIAG */ 0>(const int i, const int r) {
    return i >= r;
}

template<typename T, int ttype>
kernel void kernel_tri(
        constant lm_ggml_metal_kargs_tri & args,
        device const char * src0,
    ...
    for (int64_t i0 = tpitg.x; i0 < args.ne00; i0 += ntg.x) {
        ...
        dst_row[i0] = static_cast<T>(_lm_ggml_vec_tri_cmp<ttype>(i0, i1)) * src_row[i0];
    }
}
...
kernel void kernel_soft_max(
        constant lm_ggml_metal_kargs_soft_max & args,
        device const  char * src0,
        device const  char * src1,
        device const  char * src2,
        device        char * dst,
...
kernel void kernel_ssm_conv_f32_f32(
        constant lm_ggml_metal_kargs_ssm_conv & args,
...
// ref: ggml.c:lm_ggml_compute_forward_ssm_scan_f32, Mamba-2 part
// Optimized version: reduces redundant memory loads by having one thread load shared values
kernel void kernel_ssm_scan_f32(
        constant lm_ggml_metal_kargs_ssm_scan & args,
        device const void * src0,
        device const void * src1,
...
kernel void kernel_gated_delta_net_impl(
        constant lm_ggml_metal_kargs_gated_delta_net & args,
        device const char * q,
        device const char * k,
        device const char * v,
        device const char * g,
...
kernel void kernel_turbo_wht(
        constant lm_ggml_metal_kargs_turbo_wht & args,
...
kernel void kernel_solve_tri_f32(
        constant lm_ggml_metal_kargs_solve_tri & args,
        device   const char * src0,
        device   const char * src1,
        device         char * dst,
        threadgroup    char * shmem [[threadgroup(0)]],
...
kernel void kernel_argmax_f32(
        constant lm_ggml_metal_kargs_argmax & args,
        device   const char * src0,
        device         char * dst,
        threadgroup    char * shmem [[threadgroup(0)]],
        uint  tgpig[[threadgroup_position_in_grid]],
...
kernel void kernel_l2_norm_impl(
        constant lm_ggml_metal_kargs_l2_norm & args,
        device const char * src0,
        device       char * dst,
        threadgroup float * shmem_f32 [[threadgroup(0)]],
        uint3   tgpig[[threadgroup_position_in_grid]],
...
kernel void kernel_group_norm_f32(
        constant lm_ggml_metal_kargs_group_norm & args,
        device const float * src0,
        device       float * dst,
        threadgroup float  * buf [[threadgroup(0)]],
        uint tgpig[[threadgroup_position_in_grid]],
...
kernel void kernel_mul_mv_q1_0_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_q1_0_f32_impl<N_R0_Q1_0, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q4_0_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    mul_vec_q_n_f32_impl<block_q4_0, N_R0_Q4_0, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q4_1_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
     mul_vec_q_n_f32_impl<block_q4_1, N_R0_Q4_1, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q5_0_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    mul_vec_q_n_f32_impl<block_q5_0, N_R0_Q5_0, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q5_1_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    mul_vec_q_n_f32_impl<block_q5_1, N_R0_Q5_1, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q8_0_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_q8_0_f32_impl<N_R0_Q8_0, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_tq3_1s_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_tq3_1s_f32_impl<N_R0_TQ3_1S, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_tq4_1s_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_tq4_1s_f32_impl<N_R0_TQ4_1S, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
void kernel_mul_mv_ext_q4_f32_impl(
        constant lm_ggml_metal_kargs_mul_mv_ext & args,
        device const char * src0,
        device const char * src1,
        device       char * dst,
        uint3   tgpig[[threadgroup_position_in_grid]],
...
kernel void kernel_mul_mv_t_t(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_t_t_disp<T0, T1, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_t_t_4(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_t_t_4_disp<T0, T04, T1, T14, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_t_t_short(
        ...
        uint3  tgpig[[threadgroup_position_in_grid]],
        ushort tiisg[[thread_index_in_simdgroup]]) {
    kernel_mul_mv_t_t_short_impl<T0, T1, constant lm_ggml_metal_kargs_mul_mv &>(
        args,
        src0,
        src1,
        dst,
...
typedef void (im2col_t)(
        constant lm_ggml_metal_kargs_im2col & args,
...
kernel void kernel_conv_2d(
        constant lm_ggml_metal_kargs_conv_2d & args,
...
typedef void (conv_transpose_1d_t)(
        constant lm_ggml_metal_kargs_conv_transpose_1d & args,
        device const float * src0,
...
typedef void (conv_transpose_2d_t)(
        constant lm_ggml_metal_kargs_conv_transpose_2d & args,
        device const float * src0,
        device const float * src1,
        device        char * dst,
        uint3   tgpig[[threadgroup_position_in_grid]],
...
kernel void kernel_upscale_nearest_f32(
    constant lm_ggml_metal_kargs_upscale & args,
    device  const char * src0,
    device        char * dst,
    uint3 tgpig[[threadgroup_position_in_grid]],
    uint3 tpitg[[thread_position_in_threadgroup]],
...
kernel void kernel_roll_f32(
    constant lm_ggml_metal_kargs_roll & args,
    device  const char * src0,
    device        char * dst,
    uint3 tgpig[[threadgroup_position_in_grid]],
    uint3 tpitg[[thread_position_in_threadgroup]],
...
kernel void kernel_arange_f32(
    constant   lm_ggml_metal_kargs_arange & args,
    device        char * dst,
    uint3 tgpig[[threadgroup_position_in_grid]],
    uint3 tpitg[[thread_position_in_threadgroup]],
    uint3   ntg[[threads_per_threadgroup]]) {
...
kernel void kernel_timestep_embedding_f32(
    constant  lm_ggml_metal_kargs_timestep_embedding & args,
    device  const char * src0,
    device        char * dst,
    uint3 tgpig[[threadgroup_position_in_grid]],
    uint3 tpitg[[thread_position_in_threadgroup]],
...
kernel void kernel_flash_attn_ext_pad(
        constant lm_ggml_metal_kargs_flash_attn_ext_pad & args,
        device const char * k,
        device const char * v,
...
kernel void kernel_flash_attn_ext_blk(
        constant lm_ggml_metal_kargs_flash_attn_ext_blk & args,
        device const char * mask,
        device       char * dst,
        uint3  tgpig[[threadgroup_position_in_grid]],
        ushort tiisg[[thread_index_in_simdgroup]]) {
...
kernel void kernel_flash_attn_ext_vec(
        constant lm_ggml_metal_kargs_flash_attn_ext_vec & args,
        device const char * q,
        device const char * k,
        device const char * v,
        device const char * mask,
...
kernel void kernel_flash_attn_ext_vec_reduce(
        constant lm_ggml_metal_kargs_flash_attn_ext_vec_reduce & args,
...
kernel void kernel_turbo_flash_p1(
        constant lm_ggml_metal_kargs_turbo_flash_p1 & args,
        device const char * q,
        device const char * k,
        device const char * v,
        device const char * mask,
...
kernel void kernel_turbo_flash_p2(
        constant lm_ggml_metal_kargs_turbo_flash_p2 & args,
...
kernel void kernel_mul_mv_q2_K_f32(
    ...
    kernel_mul_mv_q2_K_f32_impl<N_R0_Q2_K, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q3_K_f32(
    ...
    kernel_mul_mv_q3_K_f32_impl<N_R0_Q3_K, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q4_K_f32(
    ...
    kernel_mul_mv_q4_K_f32_impl<N_R0_Q4_K, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q5_K_f32(
    ...
    kernel_mul_mv_q5_K_f32_impl<N_R0_Q5_K, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_q6_K_f32(
    ...
    kernel_mul_mv_q6_K_f32_impl<N_R0_Q6_K, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq2_xxs_f32(
        ...
        ushort tiisg[[thread_index_in_simdgroup]],
        ushort sgitg[[simdgroup_index_in_threadgroup]]) {
    kernel_mul_mv_iq2_xxs_f32_impl<N_R0_IQ2_XXS, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq2_xs_f32(
    ...
    kernel_mul_mv_iq2_xs_f32_impl<N_R0_IQ2_XS, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq3_xxs_f32(
    ...
    kernel_mul_mv_iq3_xxs_f32_impl<N_R0_IQ3_XXS, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq3_s_f32(
    ...
    kernel_mul_mv_iq3_s_f32_impl<N_R0_IQ3_S, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq2_s_f32(
    ...
    kernel_mul_mv_iq2_s_f32_impl<N_R0_IQ2_S, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq1_s_f32(
    ...
    kernel_mul_mv_iq1_s_f32_impl<N_R0_IQ1_S, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq1_m_f32(
    ...
    kernel_mul_mv_iq1_m_f32_impl<N_R0_IQ1_M, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, nullptr, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq4_nl_f32(
    ...
    kernel_mul_mv_iq4_nl_f32_impl<N_R0_IQ4_NL, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_iq4_xs_f32(
    ...
    kernel_mul_mv_iq4_xs_f32_impl<N_R0_IQ4_XS, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_mul_mv_mxfp4_f32(
    ...
    kernel_mul_mv_mxfp4_f32_impl<N_R0_MXFP4, constant lm_ggml_metal_kargs_mul_mv &>(args, src0, src1, dst, shmem, tgpig, tiisg, sgitg);
}
...
kernel void kernel_diag_f32(
        constant lm_ggml_metal_kargs_diag & args,
        device   const char * src0,
        device         char * dst,
        uint3  tgpig[[threadgroup_position_in_grid]],
        ushort tiitg[[thread_index_in_threadgroup]]) {
...
#endif // LM_GGML_METAL_HAS_TENSOR

template<short ne20> // n_expert_used
kernel void kernel_mul_mm_id_map0(
        constant lm_ggml_metal_kargs_mul_mm_id_map0 & args,
        device  const char * src2,
        device        char * htpe,
        device        char * hids,
        threadgroup   char * shmem [[threadgroup(0)]],
...
#ifndef LM_GGML_METAL_HAS_TENSOR
    S0_8x8 ma[4];
    S1_8x8 mb[2];
...
typedef decltype(mmv_fn<kernel_mul_mv_t_t_disp<half, half, lm_ggml_metal_kargs_mul_mv>>) mul_mv_disp_fn_t;
...
kernel void kernel_pool_2d_max_f32(
        constant    lm_ggml_metal_kargs_pool_2d & args,
        device  const float * src0,
        device        float * dst,
...
kernel void kernel_opt_step_adamw_f32(
        constant    lm_ggml_metal_kargs_opt_step_adamw & args,
        device       float * x,
...
kernel void kernel_opt_step_sgd_f32(
        constant    lm_ggml_metal_kargs_opt_step_sgd & args,
        device       float * x,
        device const float * g,
        device const float * pars,
        uint        gid[[thread_position_in_grid]]) {
...
kernel void kernel_memset(
        constant lm_ggml_metal_kargs_memset & args,
        device T * dst,
        uint tpig[[thread_position_in_grid]]) {
    dst[tpig] = args.val;
}
...
kernel void kernel_count_equal(
        constant lm_ggml_metal_kargs_count_equal & args,
        device   const char * src0,
        device   const char * src1,
