...
static const struct lm_ggml_type_traits type_traits[LM_GGML_TYPE_COUNT] = {
    ...
    [LM_GGML_TYPE_TURBO2_0] = {
        ...
        .is_quantized             = true,
        .to_float                 = (lm_ggml_to_float_t) dequantize_row_turbo2_0,
        .from_float_ref           = (lm_ggml_from_float_t) quantize_row_turbo2_0_ref,
    },
    [LM_GGML_TYPE_TQ3_1S] = {
        .type_name                = "tq3_1s",
        .blck_size                = QK_TQ3_0,
        ...
        .is_quantized             = true,
        .to_float                 = (lm_ggml_to_float_t) dequantize_row_tq3_1s,
        .from_float_ref           = (lm_ggml_from_float_t) quantize_row_tq3_1s_ref,
    },
    [LM_GGML_TYPE_TQ4_1S] = {
        .type_name                = "tq4_1s",
        .blck_size                = QK_TQ4_1S,
        ...
        .is_quantized             = true,
        .to_float                 = (lm_ggml_to_float_t) dequantize_row_tq4_1s,
        .from_float_ref           = (lm_ggml_from_float_t) quantize_row_tq4_1s_ref,
    },
    [LM_GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
void lm_ggml_mul_mat_set_hint(
    ...
    lm_ggml_set_op_params_i32(a, 1, hint_i32);
}
...
struct lm_ggml_tensor * lm_ggml_turbo_wht(
    ...
    LM_GGML_ASSERT(group_size == 32 || group_size == 64 || group_size == 128);
    LM_GGML_ASSERT(a->ne[0] % group_size == 0);
...
size_t lm_ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case LM_GGML_TYPE_TURBO3_0: result = quantize_turbo3_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case LM_GGML_TYPE_TURBO4_0: result = quantize_turbo4_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case LM_GGML_TYPE_TURBO2_0: result = quantize_turbo2_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case LM_GGML_TYPE_TQ3_1S:  result = quantize_tq3_1s(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case LM_GGML_TYPE_TQ4_1S:  result = quantize_tq4_1s(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
